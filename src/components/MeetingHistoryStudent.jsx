    ...
    const fetchMeetingHistory = async () => {
        try {
            let result = await axios({
                url: `http://localhost:8000/api/meeting/fetchMeetingLogsForStudent/${initiator}`,
                method: "GET"
            });
                    ...
                    return (
                        <div className="history-card" key={idx}>
                            ...
                            <div className="history-label-row">
                                ...
                                <span className="history-value">{detail?.requestee || detail?.requesteeEmail || "-"}</span>
                            </div>
                            <div className="history-label-row">
